            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between no-print flex-wrap gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <Badge className={`capitalize border-0 text-xs ${challan.status === 'paid' ? 'bg-green-100 text-green-700' : challan.status === 'partial' ? 'bg-amber-100 text-amber-700' : challan.status === 'void' ? 'bg-slate-200 text-slate-600' : 'bg-red-100 text-red-700'}`}>
                            {challan.status}
                        </Badge>
                    </div>
