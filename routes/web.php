...
Route::middleware('auth')->group(function () {
    ...
    */
    Route::middleware(['role:super-admin|school-admin|principal|teacher|accountant|librarian', 'school.context'])
        ...
        ->group(function () {
            ...
            // Students Module
            Route::middleware('school.module:students')->group(function () {
            ...
            // Staff Module
            Route::middleware('school.module:staff')->group(function () {
            ...
            // Exams Module
            Route::middleware('school.module:exams')->group(function () {
            ...
            // Timetable Module
            Route::middleware('school.module:timetable')->group(function () {
            ...
            // Attendance Module
            Route::middleware('school.module:attendance')->group(function () {
            ...
            // HR Module
            Route::middleware('school.module:hr')->group(function () {
            ...
            // Library Module
            Route::middleware('school.module:library')->group(function () {
            ...
            // Inventory Module
            Route::middleware('school.module:inventory')->group(function () {
            ...
            // Hostel Module
            Route::middleware('school.module:hostel')->group(function () {
            ...
            // Transport Module
            Route::middleware('school.module:transport')->group(function () {
            ...
            // Homework Module
            Route::middleware('school.module:homework')->group(function () {
            ...
            Route::middleware('school.module:communication')->group(function () {
            ...
            // Reports & Analytics Module (excluding base /dashboard)
            Route::middleware('school.module:reports')->group(function () {
            ...
            // Core Settings & Administration (Ungated Core)
    ...
    */
    Route::middleware('role:student')->prefix('school/student')->name('student.')->group(function () {
        ...
        Route::middleware('school.module:timetable')->get('timetable',     [StudentPortalController::class, 'timetable'])->name('timetable');
        Route::middleware('school.module:attendance')->get('attendance',    [StudentPortalController::class, 'attendance'])->name('attendance');
        Route::middleware('school.module:exams')->get('results',       [StudentPortalController::class, 'results'])->name('results');
        Route::middleware('school.module:homework')->get('homework',      [StudentPortalController::class, 'homework'])->name('homework');
        Route::middleware('school.module:fees')->get('fees',          [StudentPortalController::class, 'fees'])->name('fees');
        Route::middleware('school.module:communication')->get('announcements', [StudentPortalController::class, 'announcements'])->name('announcements');
    });

    Route::middleware('role:parent')->prefix('school/parent')->name('parent.')->group(function () {
        Route::get('dashboard',     [ParentPortalController::class, 'dashboard'])->name('dashboard');
        Route::middleware('school.module:attendance')->get('attendance',    [ParentPortalController::class, 'attendance'])->name('attendance');
        Route::middleware('school.module:exams')->get('results',       [ParentPortalController::class, 'results'])->name('results');
        Route::middleware('school.module:fees')->get('fees',          [ParentPortalController::class, 'fees'])->name('fees');
        Route::middleware('school.module:communication')->get('announcements', [ParentPortalController::class, 'announcements'])->name('announcements');
    });
